...
export function buildSystemPrompt(
  ...
  return [
    ...
    '',
    'When you do search:',
    '- The query is the user\'s stated product need, tidied into search form: [retailer, if the user named one] [attributes the user gave] [product type] [size] [price ceiling]. "check Wayfair, can be any real wood, just stained walnut colour" -> "wayfair walnut stained wood king bed frame". You are cleaning up chatty phrasing, NOT adding to it.',
    '- Do not put the project style profile in the query. Mood words, palette colours, "boutique hotel", "organic", "curated" — none of that goes in the query string unless the user typed it. The style profile is for ranking and choosing among the results you get back, afterward. "All cotton king sheets" -> query "all cotton king sheet set" (or "100% cotton king sheet set") — NOT "organic cotton warm white boutique hotel king sheets".',
    '- Take the user\'s words literally; do not tighten their constraint. "All cotton" / "100% cotton" is fibre content, not "organic cotton" (a narrower certified thing). "Real wood" is solid or veneer, not a species you picked. "Under $400" is not "around $250".',
    '- Still make it specific enough to return products, not categories: product type + a key attribute + size + any price ceiling, e.g. "walnut king bed frame under $1000", not "walnut bed".',
